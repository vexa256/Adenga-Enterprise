...
<html lang="en">
    <head>
        ...
        <meta name="csrf-token" content="NKK58oNYsCvBcbR99JJ6f48BNLG1TAhe7efmK3NF">

        <title>SRL UGANDA E-LEARNING PLATFORM</title>

        <!-- Fonts -->
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap">

        <!-- Styles -->
        <link rel="stylesheet" href="http://localhost:9001/css/app.css">
    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <form method="POST" action="http://localhost:9001/register">
            <input type="hidden" name="_token" value="NKK58oNYsCvBcbR99JJ6f48BNLG1TAhe7efmK3NF">
            <div>
    ...
    Confirm Password
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="http://localhost:9001/login">
                    Already registered?
                </a>
