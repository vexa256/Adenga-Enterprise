<div class="col-md-12">
  <div class="callout callout-danger shadow-lg">
               <h5>  <i class="fas fa-chalkboard-teacher text-primary fa-2x"></i>  {{ $Title }}</h5>
...
<div class="container">
	...
	<div class="card shadow-lg">
		<div class="card-header">
			...
			<h3>Scoreboard Course Selection Form</h3>
		</div>
...
@endif
			<form method="POST" action="{{ route('StudentScoreboard') }}">
